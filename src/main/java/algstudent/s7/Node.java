...
public abstract class Node implements Comparable<Node> {
	...
	public abstract void calculateHeuristicValue(); //b/o
	public abstract ArrayList<Node> expand(); //recorre y crea nodo por cancion1
	public abstract boolean isSolution(); //recorre y busca si alguna entra == sol
}
